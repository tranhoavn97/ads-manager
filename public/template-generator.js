...
(function () {
  ...
  function downloadStandardTemplate() {
    ...
    const rows = [
      headers,
      ['Tún TV', 'https://www.facebook.com/reel/1528947745259708', 'Bài viết có sẵn', 'CTA tự động', 'https://s.shopee.vn/7AbSPiczTW', 'Mua ngay', '17387640570_SHPAAR27_campaign01', '17387640570_SHPAAR27_adgroup01', '17387640570_SHPAAR27_ad01', 'Lưu lượng truy cập', 'Việt Nam', 200000, 'Cấp nhóm', 'Hàng ngày', '26/06/2026', '08:00', '30/06/2026', '23:59', 'Tạm dừng', 'Mẫu: Existing Post + CTA Shopee'],
    ...
    const guide = [
      ['Nhóm', 'Giá trị'], ['Chế độ nội dung', 'Bài viết có sẵn'], ['Xử lý CTA', 'CTA tự động'], ['Xử lý CTA', 'Giữ CTA'], ['Xử lý CTA', 'Bỏ CTA'], ['Nút CTA', 'Mua ngay'], ['Nút CTA', 'Tìm hiểu thêm'], ['Loại chiến dịch', 'Lưu lượng truy cập'], ['Quốc gia', 'Việt Nam'], ['Quốc gia', 'Thái Lan'], ['Quốc gia', 'Singapore'], ['Cấp ngân sách', 'Cấp nhóm'], ['Cấp ngân sách', 'Cấp chiến dịch'], ['Loại ngân sách', 'Hàng ngày'], ['Loại ngân sách', 'Trọn đời'], ['Trạng thái', 'Tạm dừng'], ['Trạng thái', 'Bật']
    ];

    const help = [
      ['Cột', 'Cách nhập'], ['Tên Page', 'Nhập tên Page, link Page hoặc Page ID. Khuyến nghị nhập Page ID để chính xác nhất.'], ['Link bài viết', 'Dán link post/reel/photo/video Facebook. Với Reel, tool sẽ cố lấy object_story_id từ Video ID.'], ['Chế độ nội dung', 'Chỉ dùng: Bài viết có sẵn.'], ['Xử lý CTA', 'Dùng: CTA tự động để gắn Mua ngay + link Shopee.'], ['Link CTA', 'Dán link Shopee đầy đủ, bắt đầu bằng https://'], ['Nút CTA', 'Khuyến nghị: Mua ngay.'], ['Loại chiến dịch', 'Chỉ dùng: Lưu lượng truy cập.'], ['Ngân sách', 'Nhập số, ví dụ 200000.'], ['Trạng thái', 'Khuyến nghị Tạm dừng để kiểm tra trước khi bật.']
    ];
